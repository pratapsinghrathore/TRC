...
2Bacon/2Sausage with 2 Fried Egg or Bacon with brie (served with a pot of home made chutncy)<br />
...
<div class="clr"></div>
<div class="conleft">
<p class="pro_head">VEGETABLE SHASHLIK<br />
Chicken Shashlik<br />                                
Bangers and Hash</p>
<p class="pro_text">Succulent,genuine english chicken/
lamb sausages/cottage cheese
served with rich gravy and hash
brown.</p>
<p class="pro_head">LAMB STEAK
</p>
<p class="pro_text">Aged, center-cut, strip steak grilled to
Your liking and topped with Merlot-
garlic butter. Served with white
 Cheddar smashed potatoes, gravy 
and fresh vegetables.</p>
<p class="pro_head">THE TRC QUICHE<br />
</p>
<p class="pro_text">Our house specialty quiche batter with your choice of INGREDIENTS.</p>
<p class="pro_head">QUICHE LORRAINE<br />
</p>
<p class="pro_text">Classic recipe with bacon.</p>
<p class="pro_head">QUICH DE LA MER<br />
</p>
<p class="pro_text">Baked with lightly seasoned jumbo shrimp and<br />
prawns</p>
<p class="pro_head">VEGETALBLE QUICHE<br />
</p>
<p class="pro_text">Baked with roasted red pepper,asparagus and carrots.</p>
<p class="pro_head">SHEPHERDS PIE<br />
</p>
<p class="pro_text">Traditional english lamb pie baked with english peas and mash potato in rich gravy.</p>
</div>
<div class="product_right">
  <p class="pro_head">VEGETABLE-AU-GRATIN<br /></p>
<p class="pro_text">fresh veggies grilled to your liking, topped with white <br />
  sauce-------</p>
<p class="pro_head">TEA SANDWICHES</p>
<p class="pro_text">sandwich freshly made to your taste with multigrain <br />
bread.----</p>
<p class="veg_text">Egg Salad</p>
<p class="veg_text">Tuna Salad</p>
<p class="veg_text">Chicken Salad</p>
<p class="veg_text">Hawaiian Sam Salad</p>
<p class="veg_text">Tomato and Cheese</p>
<p class="veg_text">Taco</p>
<p class="veg_text">Cucumber</p>
<p class="veg_text">Olive & Cream Cheese.</p>
</div>
<div class="clr"></div>
</div>
