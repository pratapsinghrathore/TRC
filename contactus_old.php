...
switch($act)
{
			...
			$retmail_2=mail('pradeeppathak07@gmail.com', $subject, $confirmbody, $headers);
				...
				if($retmail_1 && $retmail_2)
				{
					...
					$subject1="Free cup of Tea from The Tea Room Co.";
						...
						/*$content.='<table width="57%" border="0" align="center" cellpadding="0" cellspacing="0">
								  <tr>
									<td align="left" valign="top" style="background:#d8c30e;padding:5px;"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="background:#351f14;">
								  <tr>
									<td colspan="2" style="padding:15px;" align="center"><p style="font-family:Trebuchet MS;color:#9C0; font-weight:bold; font-size:18px;">GET YOUR FREE CUP OF TEA</p></td>
									</tr>
								  <tr>
									<td width="20%"  style="padding:0 20px 20px 20px;" valign="top"><img src="http://demoprojects.co.in/tea/images/logo.jpg" width="155" height="99" title="The Tea Room Co."/></td>
									<td width="80%" align="left" valign="top" style="vertical-align:text-top;">
									<p style="font:bold 14px/16px  Verdana, Geneva, sans-serif;color:#ca9231; margin:0px;">Dear '.$con_name.',</p>
									<p style="font-family:Trebuchet MS;color:#fff; font-size:14px;" >Your Code for free cup of Tea is :- <span style="color:#ca9231; font-weight:bold;">'.$rnd_id.'</span><br />
									Please bring a copy of this email and get a Free Cup of Tea at any of our outlets. 
									 <br /><br />
									Thank You again.<br />
									The Tea Room Co. Team</p>
									</td>
									  </tr>
									  <tr>
										<td colspan="2">&nbsp;</td>
						...
						$content.='<div style="width:50%;margin:0 auto;position:relative;">
	...
	//$errMsg='<script type="text/javascript">alert("Thank you for your valuable Feedback to us.\n Please check your email. We have sent a code for Free cup of Tea in our outlet.\n Thank You again.");';		
